...
const characterNames: Record<CharacterId, string> = { cottontail: 'Cottontail', momo: 'Momo the penguin', toby: 'Toby the fox', ollie: 'Ollie the otter', coral: 'Coral the clownfish', biscuit: 'Biscuit the puppy', koala: 'Bridey the koala', teddy: 'Adi the teddy bear', panda: 'Scarlet the panda', tiger: 'Elena the tiger', piggy: 'Piggy the pig', parrot: 'Polly the parrot', mila: 'Mila the cow', gabby: 'Gabby the giraffe', amsaal: 'Amsaal the chick', misha: 'Misha the strawberry cow', joy: 'Joy the red panda', melly: 'Melly the harp seal', martin: 'Martin the hedgehog', hazel: 'Hazel the capybara', bubbles: 'Bubbles the axolotl', rocky: 'Rocky the raccoon', ellie: 'Ellie the elephant', pip: 'Pip the goat', clover: 'Clover the frog', maple: 'Maple the squirrel', lulu: 'Lulu the alpaca', finn: 'Finn the fennec fox', daisy: 'Daisy the duckling', hattie: 'Hattie the hippo', kiki: 'Kiki the lemur', pango: 'Pango the pangolin', honey: 'Honey the bumblebee', roo: 'Roo the kangaroo', snowy: 'Snowy the snow leopard', pigeon: 'Pigeon the pigeon', honey_bear: 'Honey the bear', emi: 'Emi the owl', micheal: 'Micheal the turtle', emily: 'Emily the dolphin', frog: 'Frog the frog', butterfly: 'Butterfly the butterfly', thomas: 'Thomas the eagle' };
